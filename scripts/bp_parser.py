...
def parse(filepath: str) -> dict[str, Any]:
    ...
    Returns:
        {
            meta: {name, version, bpversion, artifact_type, narrative, runmode},
    ...
    artifact_type = "object" if root_tag == "object" else "process"
    ...
    meta = {
        ...
        "type": inner_proc.attrib.get("type", artifact_type),
    }

    # Subsheet registry (schema §3)
    implicit_page_name = "Initialize" if artifact_type == "object" else "Main Page"
    pages = {
        IMPLICIT_PAGE_ID: {
...
def print_summary(result: dict, filepath: str) -> None:
    ...
    print(f"artifact_type : {meta['artifact_type']}")

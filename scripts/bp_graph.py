...
from bp_html_report import _full_traversal
...
def build_graph(result: dict, include_data: bool = False) -> graphviz.Digraph:
    ...
    g.attr(
        ...
        fontsize="11",
        bgcolor="white",
        label=f"{meta['name']}  |  {meta['artifact_type'].upper()}  |  BP {meta['bpversion']}",
        labelloc="t",
        labeljust="l",
        pad="0.4",
        nodesep="0.35",
...
def render(result: dict, output_stem: str, include_data: bool = False) -> tuple[str, str]:
    """
